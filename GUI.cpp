...
void GUI::showConfigWindow()
{
    if (this->show_config_window) {
        ...
        ImGui::Begin("Config Window", &this->show_config_window);   // Pass a pointer to our bool variable (the window will have a closing button that will clear the bool when clicked)
        {
            ...
            ImGui::Bullet(); ImGui::TextWrapped(u8"Choisir une velocit� de d�part + une masse.");
            ImGui::Bullet(); ImGui::TextWrapped(u8"Ajouter des particules � la position que vous souhaitez sur l'axe Z avec le click droit de la souris.");
            ImGui::Bullet(); ImGui::TextWrapped(u8"Start Simulation.");
            ImGui::Bullet(); ImGui::TextWrapped(u8"Bouger la premi�re particule ajout�e via un click gauche sur la souris.");
            ImGui::Bullet(); ImGui::TextWrapped(u8"Toutes les autres particules seront reli� � cette premi�re particule.");
            ImGui::Spacing();
            ImGui::TextWrapped(u8"Cam�ra Tips :");
            ImGui::Bullet(); ImGui::TextWrapped(u8"Zoomer gr�ce � la molette de la souris");
            ImGui::Bullet(); ImGui::TextWrapped(u8"Changer l'orientation de la camera en maintenant appuy� la molette et en d�pla�ant la souris.");
