		...
		if (this->begin("Render")) {
            ...
            // Top buttons
            {
                this->HelpMarker(
                        ...
                        "- Bouger la premi�re particule ajout�e (Mouse right).\n"
                        "Toutes les autres particules seront reli� � cette premi�re particule.\n"
                        "Zoomer gr�ce � la molette de la souris\n"
                        "Changer l'orientation de la camera en maintenant appuy� la molette et en d�pla�ant la souris.");
