...
void Shader::setVec3(const std::string &name, const Vector3 &vector3) const
{
    glUniform3f(glGetUniformLocation(this->ID, name.c_str()), vector3.GetX(), vector3.GetY(), vector3.GetZ());
}
// ------------------------------------------------------------------------
